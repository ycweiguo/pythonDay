# -*- coding: utf-8 -*-
# Generated by Django 1.11.26 on 2019-11-09 03:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='user',
            name='graduate_time',
            field=models.CharField(default='2000-10-31', max_length=20),
        ),
        migrations.AddField(
            model_name='user',
            name='id_number',
            field=models.CharField(default='11010819901216982', max_length=30),
        ),
        migrations.AddField(
            model_name='user',
            name='job',
        ...
        migrations.AddField(
            model_name='user',
            name='phone',
            field=models.CharField(default='18393905493', max_length=30),
        ),
        migrations.AddField(
            model_name='user',
            name='school',
            field=models.CharField(default='北京化工大学', max_length=30),
        ),
        migrations.AddField(
            model_name='user',
            name='sex',
